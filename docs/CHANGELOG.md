...
- [chore] macro 维度理论满分 5 键：monetary/liquidity/sector 由规则 + 行业 KB 自动覆盖；us_china_impact/regulatory_risk 由 LLM 在 six_dimension_inputs 主观补充。生产中如 11 只自选股 LLM 全部输出 5 键，macro indicators 数 = 5。
