...
class PushoverSender:
    def __init__(self, config: Config):
        ...
        Args:
            config: 配置对象
        """
        self._pushover_config: _PushoverConfig = {
    ...
    def send_to_pushover(
        ...
        *,
        ...
        user_key = cast(str, self._pushover_config["user_key"])
        api_token = cast(str, self._pushover_config["api_token"])
        ...
        *,
        ...
        try:
            ...
            response = requests.post(
                api_url, data=payload, timeout=timeout_seconds or 30
            )
