...
const categoryDescriptionMap: Record<UiLanguage, Partial<Record<SystemConfigCategory, string>>> = {
  ...
  agent: '管理 Agent 模式、策略和多 Agent 编排配置。',
...
const fieldTitleMap: Record<string, string> = {
  ...
  AGENT_DEEP_RESEARCH_BUDGET: '深度研究预算（Deep Research）',
  ...
  AGENT_CONTEXT_COMPRESSION_TRIGGER_TOKENS: '压缩触发阈值（Token 数）',
  AGENT_CONTEXT_PROTECTED_TURNS: '原文保护轮数',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  REPORT_LANGUAGE: '通知报告语言（zh 表示中文，en 表示英文）。',
  ...
  MARKET_REVIEW_REGION: '大盘复盘默认市场区域（例如 A 股 cn、港股 hk、美股 us）。',
